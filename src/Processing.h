...
class Processing {
 public:
  ...
  static int   getSizeTuneLst();

 private:
  static constexpr float SAMPLE_RATE     = 16000.0f;
  static constexpr int   MEDIAN_FRAMES   = 5;
  static constexpr int   MIN_SPINS_MS    = 80;     // TODO: tune this param based on testing
  ...
  // Frequency gates — wide enough to cover all alternate tunings
  static constexpr float MIN_HZ[6] = {60.0f, 90.0f, 122.0f, 165.0f, 213.0f, 280.0f};
  static constexpr float MAX_HZ[6] = {87.0f, 120.0f, 160.0f, 210.0f, 260.0f, 360.0f};
  ...
  // Alternate tunings (Standard, Drop D, Open G, Open D, D Standard)
  static constexpr Tuning _tunings[] = {
      {"E Std.", {"E", "A", "D", "G", "B", "e"},
          {82.41f, 110.0f, 146.83f, 196.0f, 246.94f, 329.63f}},
      {"D Std.", {"D", "G", "C", "F", "A", "D"},
          {73.42f, 98.0f, 130.81f, 174.61f, 220.0f, 293.66f}},
      {"Drop D", {"D", "A", "D", "G", "B", "e"},
      ...
      {"E Flat", {"Eb", "Ab", "Db", "Gb", "Bb", "eb"},
          {77.78f, 103.83f, 138.59f, 185.0f, 233.08f, 311.13f}},
  };
